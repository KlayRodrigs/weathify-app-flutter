...
Future<void> setupInjection() async {
  ...
  inject.registerSingleton(AmplitudeAnalytics());

  inject.registerFactory<WTRouterConfig>(() => WTRouterConfig(rootNavigatorKey: inject<GlobalKey<NavigatorState>>(instanceName: "global")));
